...
class CentralCorridor(Scene):
  ...
  def enter(self):
    ...
    print "mission is to get the neutron destruct bomb from the Weapons's Armory"
    ...
    if action == "shoot!":
      ...
      print "off your aim. Your laser hits his costume but misses him entirely. Then "
      ...
      print "In the middle of your artful dodge our foot slips and you"
      print "bang uour head on the metal wall and pass out."
...
class TheBridge(Scene):
  ...
  def enter(self):
    ...
    print "under your arm and surprise 5 Gothons who are try to"
    ...
    if action == "throw the bomb":
      ...
      print "place the bomb on the floor, pointing you blaster at it."
